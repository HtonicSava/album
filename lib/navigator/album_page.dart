...
import 'package:album/navigator/parser.dart';
...
///Each Screen must extend this class and provide its functionality
 abstract class AlbumPage extends Page {
   ...
   ///provide a default Transition for the app ( can delete it if want, flutter already has one)
